...
| i18n locale files   | lowercase                      | `en.json`, `vi.json`            |
...
The project currently ships with English and Vietnamese locale files. Keep layout logic LTR unless you intentionally add an RTL language later.
